...
- For **Monday, March 17**: For Luke 2.1–2.4, look up every word. Know the *case, number,* and *gender* of every noun, article, and adjective. Know the *mood, voice, tense, [person],* and *[number]* of every verb. Find which verbs are present in the Principal Parts chart from the textbook, and which are not.
