...
- For **Friday, March 14**: Watch [this video](https://www.youtube.com/watch?v=1UHt0Nau3CQ) on Greek participles. It is a focused on NT Greek, but applicable across all ancient Greek. Also, you can go ahead and save [this text file](texts/Luke2_for_alignment.txt) to your computer, and set up [Ugarit](http://ugarit.ialigner.com/index.php). **Hint**, when you go to [the page with the text file](texts/Luke2_for_alignment.txt), click on the "Raw" button before copying!
