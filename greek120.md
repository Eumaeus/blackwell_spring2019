...
- For **Friday, March 14**: Watch [this video](https://www.youtube.com/watch?v=1UHt0Nau3CQ) on Greek participles. It is a focused on NT Greek, but applicable across all ancient Greek. Also, you can go ahead and save [this text file](texts/Luke2_for_alignment.txt) to your computer, and set up [Ugarit](http://ugarit.ialigner.com/index.php). Go ahead and bookmakr [this page](http://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0155%3Abook%3DLuke%3Achapter%3D2) so you can easily look up forms. **Hint**, when you go to [the page with the text file](texts/Luke2_for_alignment.txt), click on the "Raw" button before copying! 
