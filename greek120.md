...
The first will be **in class** on **Tuesday, April 30.** It will be an in-class test. You will receive some passages of Greek and be asked questions about them. To study, review our work on **Luke 2** and **Herodotus 1.8**. Be prepared to identify nounds in different cases, to identify verbs, and to talk about short phrases and the relationship between the Greek and an aligned translation. For Herodotus 1.8, you might download [this file](https://raw.githubusercontent.com/Eumaeus/blackwell_spring2019/master/texts/candaules_1_8_complete.cex) with a complete alignment of the passage.
...
- For **Tuesday, April 23**: We will go through the Greek of Herodotus 1.8 together. On Tuesday you will get details of the final exam/project.
- For **Monday, April 15**: Prepare to write up your verb on the board and teach it to us. Vocab for Monday: τις τι, τίς τί, ὁ χρόνος -ου, τὸ εἶδος εἶδεος.
- For **Friday, April 12**: Study the forms of **γυνή, γυναικός, ἡ**. Vocab for Friday: ἡ γυνή, νομίζω, οὗτος αὕτη τοῦτο (ταῦτα).
...
- For **Friday, March 14**: Watch [this video](https://www.youtube.com/watch?v=1UHt0Nau3CQ) on Greek participles. It is a focused on NT Greek, but applicable across all ancient Greek. Also, you can go ahead and save [this text file](texts/Luke2_for_alignment.txt) to your computer, and set up [Ugarit](http://ugarit.ialigner.com/index.php). Go ahead and bookmark [this page](http://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0155%3Abook%3DLuke%3Achapter%3D2) so you can easily look up forms. **Hint**, when you go to [the page with the text file](texts/Luke2_for_alignment.txt), click on the "Raw" button before copying! 
