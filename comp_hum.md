...
- For **Friday, April 12**: Do the reading, thinking, and typing assignment [here](texts/corpus_work.md). If you think you might be interested in working a Translation API into your project, go ahead and read around on [this website](https://mymemory.translated.net); also, read about [REST](https://en.wikipedia.org/wiki/Representational_state_transfer), which can be summarized "you ask for something with an `http://` request, and get the same answer to the same question every time." If you are interested in The Shiney Things, you can download [Gephi](https://gephi.org) for your computer, and **find and do** any of the innumerable tutorials for getting started. *I am not good at Gephi, and I hate video tutorials, so if I am to help you, you need to be able to give me an introductory tutorial in Gephi.* I can help you with your Truth; the Beauty is on you.
